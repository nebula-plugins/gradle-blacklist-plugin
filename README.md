...
==============
[![Build Status](https://travis-ci.org/nebula-plugins/gradle-blacklist-plugin.svg?branch=master)](https://travis-ci.org/nebula-plugins/projects/gradle-blacklist-plugin)
[![Coverage Status](https://coveralls.io/repos/nebula-plugins/gradle-blacklist-plugin/badge.svg?branch=masterservice=github)](https://coveralls.io/github/nebula-plugins/projects/gradle-blacklist-plugin?branch=master)
